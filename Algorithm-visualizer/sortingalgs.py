...
# Row[1]
sizeEntry =  Scale(UI_frame, from_=3, to=25, digits=2, resolution=1,orient=HORIZONTAL, label="Data Size")
sizeEntry.grid(row=1, column=0,padx=5, pady=5, sticky=W)

minEntry = Scale(UI_frame, from_=0, to=10, digits=2, resolution=1,orient=HORIZONTAL, label="min value")
minEntry.grid(row=1, column=1,padx=5, pady=5)

maxEntry = Scale(UI_frame, from_=10, to=100, digits=2, resolution=1,orient=HORIZONTAL, label="max value")
